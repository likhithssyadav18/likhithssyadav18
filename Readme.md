...
- When the user mouses over the points plotted in the axes in the spider chart, then create a tooltip to display the value of the the trait of the corresponding axes as shown in the figure.
